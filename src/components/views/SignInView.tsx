...
<div className="w-full max-w-6xl mx-auto">
            <Card className="bg-gray-900/50 backdrop-blur-sm border-gray-800 overflow-hidden">
                <CardContent className="grid p-0 md:grid-cols-2">
                    <Form {...form}>
<form onSubmit={form.handleSubmit(onSubmit)} className="p-4 sm:p-6 md:p-8 flex flex-col justify-center">
...
<p className="text-gray-400 text-base lg:text-lg">
    Create stunning video experiences
            ...
            <div className="text-gray-400 text-center text-xs text-balance mt-6">
                ...
                <Link href="#" className="text-purple-400 mx-1 hover:text-purple-300 underline underline-offset-4 transition-colors">
                    Terms of Service
                </Link>
                and
                <Link href="#" className="text-purple-400 mx-1 hover:text-purple-300 underline underline-offset-4 transition-colors">
