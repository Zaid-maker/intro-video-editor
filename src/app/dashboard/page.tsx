			...
			<div className="flex flex-col lg:flex-row w-full gap-6 ">
				...
				<div className="relative w-full lg:flex-[3] h-auto lg:h-96 rounded-lg bg-[#232327]">
					...
					<div className="relative z-10 p-6 h-full flex flex-col justify-between">
						...
						<div className=" lg:absolute lg:bottom-20 -lg:mt-0 -mt-6 left-32 lg:left-52 xl:left-[19rem] 2xl:left-[25rem]">
							...
							<p className="text-gray-300 lg:text-lg text-xs lg:w-96 mb-4">
								Upload your videos or images, select a template and see what
								brainstorm is capable to do.
							</p>
					...
					<div className="absolute bottom-0">
						<Image height={100} width={100} src="/cardshadow1.webp" alt="" />
					</div>
				</div>
				...
				<div className="flex flex-col w-full lg:flex-[2] space-y-3">
					...
					<div className="relative h-auto lg:h-48 rounded-lg bg-[#232327]">
						<div className="relative z-10 p-4 sm:p-6 h-full flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
							...
							<div className="text-center lg:text-left">
								...
								<p className="text-gray-300 text-sm mb-2">
									Create your first project, discover tons of templates and
									generate any video you want.
								</p>
								<CreateProjectDialog>
									<Button className="bg-[#8B43F7] text-white text-sm font-medium rounded px-4 py-2 transition-colors duration-200 hover:bg-[#a366fa] cursor-pointer">
										Create Project
									</Button>
								</CreateProjectDialog>
							</div>
						...
						<div className="absolute bottom-0">
							<Image height={100} width={100} src="/cardshadow2.webp" alt="" />
						</div>
					</div>
				...
				{isLoadingProjects ? (
					...
					<Card className="bg-[#232327] border-gray-700">
						<CardContent className="flex flex-col items-center justify-center py-12">
							...
							<p className="text-gray-400 text-center mb-4">{projectsError}</p>
							<Button
								className="bg-[#8B43F7] hover:bg-[#a366fa] text-white"
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
						{recentProjects.map((project) => (
							<Card
								key={project.id}
								className="bg-[#232327] border-gray-700 hover:border-gray-600 transition-colors"
							>
								<CardHeader>
