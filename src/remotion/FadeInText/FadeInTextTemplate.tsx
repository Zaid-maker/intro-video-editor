            ...
            particles.push(
                <div
                    ...
                    style={{
                        ...
                        width: '2px',
                        height: '2px',
                        backgroundColor: colorShift ? `hsl(${(frame + i * 50) % 360}, 70%, 60%)` : color,
                ...
                return (
                    <h1
                        style={{
                            ...
                            textShadow: glowEffect ? `0 0 ${10 + Math.sin(frame / 10) * 10}px ${color}` : '2px 2px 4px rgba(0,0,0,0.3)',
                            filter: 'none',
                        }}
                    >
                        {text}
                ...
                return (
                    <h1 style={baseTextStyles}>
                        {characters.map((char, index) => {
                            const charDelay = (index / characters.length) * fadeInDuration * 0.5;
                            ...
                            return (
                                <span
                                    ...
                                    style={{
                                        ...
                                        textShadow: glowEffect ? `0 0 ${5 + Math.sin(frame / 10 + index) * 5}px ${color}` : 'none',
                ...
                return (
                    <h1 style={baseTextStyles}>
                        {words.map((word, wordIndex) => {
                            const wordDelay = (wordIndex / words.length) * fadeInDuration * 0.6;
                                ...
                                <span key={wordIndex}>
                                    <span
                                        style={{
                                            ...
                                            textShadow: glowEffect ? `0 0 ${8 + Math.sin(frame / 15 + wordIndex) * 8}px ${color}` : 'none',
                ...
                return (
                    <h1
                        style={{
                            ...
                            transform: rotationEffect ? `rotate(${(1 - fadeInProgress) * 180}deg)` : 'none',
                            textShadow: glowEffect ? `0 0 ${15 + Math.sin(frame / 8) * 15}px ${color}` : '2px 2px 4px rgba(0,0,0,0.3)',
                        }}
                    >
                        {text}
                    </h1>
                            ...
                            return (
                                <span
                                    ...
                                    style={{
                                        ...
                                        textShadow: glowEffect ? `0 0 ${6 + Math.sin(frame / 12 + index) * 6}px ${color}` : 'none',
                                    }}
                                >
                                    {char === ' ' ? '\u00A0' : char}
                                </span>
