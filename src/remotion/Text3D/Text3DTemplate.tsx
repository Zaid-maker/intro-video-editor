...
export const Text3DTemplate: React.FC<Text3DProps> = ({
    ...
    const createDepthLayers = () => {
        ...
        for (let i = 0; i < depth; i++) {
            ...
            const layerOpacity = interpolate(i, [0, depth - 1], [1, 0.3], { extrapolateRight: 'clamp' });
            ...
            layers.push(
                <div
                    ...
                    style={{
                        ...
                        fontWeight: '900',
                        textShadow: metallic ? `0 0 ${10 + lightFactor * 10}px ${layerColor}` : 'none',
            ...
            particles.push(
                <div
                    ...
                    style={{
                        ...
                        width: '4px',
                        height: '4px',
                        backgroundColor: colorGradient ? `hsl(${(frame + i * 20) % 360}, 70%, 60%)` : color,
                        borderRadius: '50%',
