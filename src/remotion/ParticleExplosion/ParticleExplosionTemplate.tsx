...
export const particleExplosionSchema = z.object({
    ...
    textBehavior: z.enum(['static', 'shatter', 'reform', 'pulse']).default('shatter'),
});
            ...
            particles.push(
                <div
                    ...
                    style={{
                        ...
                        boxShadow: sparkles ? `0 0 ${particleSize * 2}px ${particleColor}` : 'none',
                    }}
                />
            );
        }
    ...
    const renderText = () => {
        ...
        switch (textBehavior) {
            ...
            case 'shatter':
                ...
                return (
                    <h1 style={{...baseStyles, display: 'flex', justifyContent: 'center'}}>
                        {characters.map((char, index) => {
                            ...
                            const charY = Math.sin(charAngle) * charVelocity * explosionTime - 
                            ...
                            return (
                                <span
                                    ...
                                    style={{
                                        ...
                                        opacity: charOpacity,
                                        color: colorVariation ? `hsl(${(frame + index * 30) % 360}, 70%, 60%)` : color,
                                    }}
                                >
                                    {char === ' ' ? '\u00A0' : char}
                                </span>
                ...
                return (
                    <h1 style={{...baseStyles, display: 'flex', justifyContent: 'center'}}>
                        {reformChars.map((char, index) => {
                            ...
                            const charX = Math.cos(charAngle) * maxDistance * (1 - reformProgress);
                            const charY = Math.sin(charAngle) * maxDistance * (1 - reformProgress);
